...
Version 1.6.3 will fix the KISS frame size if, after fixing outgoing characters, it exceeds 255 bytes. This version has the ability to re-frame packets so the contents make it through. 
